...
Constant = struct.unpack('>QQ',
                         b'\x1F\xF9\xE9\xAA\xC5\xFE\x04\x08\x02\x45\x91\xDC\x5D\x52\x76\x8A')  # 3DS AES Hardware Constant

# Retail keys
KeyX0x18 = struct.unpack('>QQ',
                         b'\x82\xE9\xC9\xBE\xBF\xB8\xBD\xB8\x75\xEC\xC0\xA0\x7D\x47\x43\x74')  # KeyX 0x18 (New 3DS 9.3)
KeyX0x1B = struct.unpack('>QQ',
                         b'\x45\xAD\x04\x95\x39\x92\xC7\xC8\x93\x72\x4A\x9A\x7B\xCE\x61\x82')  # KeyX 0x1B (New 3DS 9.6)
